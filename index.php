...
if(isset($_POST['signin']))         //signin name of the session
{
$uname=$_POST['username'];            
$password=md5($_POST['password']);
$sql ="SELECT email,password,user_id FROM User WHERE email=:uname and password=:password";
...
if($query->rowCount() > 0)
{
 foreach ($results as $result) {
    ...
    $_SESSION['eid']=$result->user_id;                  //eid
  } 
$_SESSION['emplogin']=$_POST['username'];                   //emplogin
...
<html lang="en">
    ...
    <body>
          ...
          <!--   <a class="nav-item text-white font-weight-bold nav-link active ml-3" href="#">Home <span class="sr-only">(current)</span></a> -->
            ...
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="index.php">User Login</a>  
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="Register.php">New User?</a>
          </div>
          </div>
        </nav>
        ...
        <h4 class="font-weight-bold text-center text-danger">Welcome to Fastag!</h4>
                          ...
                          <div class="col-md-6 d-flex justify-content-center align-items-center">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title text-danger" style="font-size:20px;">User Login</span>
