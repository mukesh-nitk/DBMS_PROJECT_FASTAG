...
$con="update User set password=:newpassword where user_id=:empid";
                          ...
                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title text-danger" style="font-size:20px;">User details</span>
                                           ...
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <div class="input-field col s12">
                                                ...
                                                <div class="input-field col s12">
                                                   ...
                                                   <label for="email">Enter Registered User Id</label>
                                               </div>
...
$empid=$_POST['empid'];
$email=$_POST['emailid'];
$sql ="SELECT user_id FROM User WHERE Email=:email and user_id=:empid";
