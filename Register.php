...
$sql="INSERT INTO user(user_id,first_name,last_name,email,password,gender,dob,address,phone_number,status) VALUES(:empid,:fname,:lname,:email,:password,:gender,NULL,:address,:mobileno,:status)";
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color: green;">Add User</div>
     ...
     <?php  
                if($error){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($error); ?> </div><?php }?>


<div class="input-field col s12" style="margin-top: 30px;">
                    <a class="nav-item text-white font-weight-bold nav-link ml-3" href="index.php">  Back</a>
                        </div>
 <div class="input-field col  s12">
<label for="empcode">User_id(Remember this number and it should be uniquely choosen)</label>
