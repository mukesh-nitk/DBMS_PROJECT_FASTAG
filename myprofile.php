...
$sql="update user set first_name=:fname,last_name=:lname,Gender=:gender,Dob=:dob,Address=:address,Phone_number=:mobileno where email=:eid";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>User | Update Employee</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color: green;">Update User details</div>
                    </div>
...
<label for="empcode">User ID</label>
<input  name="empcode" id="empcode" value="<?php echo htmlentities($result->user_id);?>" type="number" autocomplete="off" readonly required>
...
<input id="phone" name="mobileno" type="tel" value="<?php echo htmlentities($result->phone_number);?>" maxlength="10" autocomplete="off" required>
 </div>
